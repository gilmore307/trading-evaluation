...
- Move promotion eligibility logic out of manager/model paths into this repository in controlled slices.

## Recently Accepted

- Created `trading-evaluation` as the independent benchmark, fold-settlement, and promotion-eligibility repository.
