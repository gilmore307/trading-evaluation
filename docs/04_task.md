...
- Prepared the first benchmark dataset manifest route: component manifest, feed task plan, coverage summary, and fail-closed task keys under storage-owned runtime output.
