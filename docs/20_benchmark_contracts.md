...
The promotion benchmark must be selected once and then frozen. For Layer 3 and later target-selection models, the benchmark is a historical-clock candidate-policy replay. It freezes the candidate-generation policy and historical replay substrate, not a hand-picked list of final trade targets.
