...
Promotion eligibility is the evaluation-owned decision that a candidate has enough settlement evidence to proceed to a separate activation gate.
...
- Eligibility is not activation and has no execution side effects.
