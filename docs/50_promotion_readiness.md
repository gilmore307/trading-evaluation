...
`trading-evaluation` may publish `promotion_readiness_record` after a candidate has passed frozen benchmark settlement and promotion eligibility checks. This admits the candidate to execution shadow review; it does not switch active configs.
