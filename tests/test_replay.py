...
from trading_evaluation import is_training_fold_blocked_by_replay, validate_replay_contract
...
class ReplayContractTests(unittest.TestCase):
    def test_valid_candidate_policy_replay_contract_passes(self):
        result = validate_replay_contract(VALID_CONTRACT)
        self.assertEqual(result.validation_status, "passed")
        self.assertEqual(result.warnings, ())
        self.assertEqual(result.contract.replay_mode, "candidate_policy_replay")
    ...
    def test_cli_outputs_validation_json(self):
        ...
        self.assertEqual(result["contract_type"], "evaluation_replay_contract_validation")
        self.assertEqual(result["validation_status"], "passed")
