    ...
    *,
    ...
    manifest = {
        ...
        "runtime_artifact_policy": {
            ...
            "evaluation_artifacts_role": "receipts_progress_coverage_settlement_views",
        ...
        "source_storage_policy": {
            "canonical_source_root": str(data_root),
            "coverage_scan_role": "read_existing_canonical_source_partitions",
            "provider_gap_fill_role": "write_missing_canonical_source_partitions_only",
            "replay_dataset_retains": [
                "manifest_refs",
                "coverage_rows",
                "receipt_refs",
                "input_hashes",
            ...
            "duplicate_source_body_policy": "forbidden_for_reusable_source_partitions",
            "candidate_selection_policy": "fixed_candidate_universe_and_component_graph_not_local_directory_scan",
        },
